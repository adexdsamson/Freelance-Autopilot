...
```
Agent(
  prompt="Read /home/user/Freelance-Autopilot/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/Freelance-Autopilot/.claude/gsd-core/templates/VALIDATION.md`
