...
Reference full template: `/home/user/Freelance-Autopilot/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/Freelance-Autopilot/.claude/gsd-core/templates/state.md`.
