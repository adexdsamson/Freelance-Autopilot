...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/Freelance-Autopilot/.claude/.gsd-surface.json`
(sibling to `/home/user/Freelance-Autopilot/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/Freelance-Autopilot/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/Freelance-Autopilot/.claude/skills`).
...
`/home/user/Freelance-Autopilot/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/Freelance-Autopilot/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/Freelance-Autopilot/.claude/.gsd-surface.json`
Install profile marker: `/home/user/Freelance-Autopilot/.claude/.gsd-profile`
Skill dirs: `/home/user/Freelance-Autopilot/.claude/skills/gsd-*/`
Engine module: `/home/user/Freelance-Autopilot/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/Freelance-Autopilot/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
