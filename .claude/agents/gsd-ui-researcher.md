...
Use template from `/home/user/Freelance-Autopilot/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `/home/user/Freelance-Autopilot/.claude/gsd-core/templates/UI-SPEC.md`
