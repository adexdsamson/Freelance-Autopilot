...
ones). Reference: @/home/user/Freelance-Autopilot/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/user/Freelance-Autopilot/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/user/Freelance-Autopilot/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/user/Freelance-Autopilot/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/user/Freelance-Autopilot/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/user/Freelance-Autopilot/.claude/gsd-core/templates/spec.md.
