...
<execution_context>
@/home/user/Freelance-Autopilot/.claude/gsd-core/workflows/manager.md
...
Read and execute `/home/user/Freelance-Autopilot/.claude/gsd-core/workflows/analyze-dependencies.md` end-to-end.
