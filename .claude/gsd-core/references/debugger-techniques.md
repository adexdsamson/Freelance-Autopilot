...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/Freelance-Autopilot/.claude
                  → checks /home/user/Freelance-Autopilot/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/Freelance-Autopilot/.claude/gsd-core
                  → writes to /home/user/Freelance-Autopilot/.claude/gsd-core/hooks/
