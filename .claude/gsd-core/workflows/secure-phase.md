...
```
Agent(
  prompt="Read /home/user/Freelance-Autopilot/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/Freelance-Autopilot/.claude/gsd-core/templates/SECURITY.md`
